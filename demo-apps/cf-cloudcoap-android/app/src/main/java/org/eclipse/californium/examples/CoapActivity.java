...
public class CoapActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (supportJobs < 1) {
            menu.removeItem(R.id.action_reset_statistic);
        }
        return true;
    }
    ...
    private void requestPermissions() {
        final Context applicationContext = getApplicationContext();
        supportJobs = JobManager.initialize(applicationContext);
        if (1 < supportJobs) {
            SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(applicationContext);
    ...
    private final SharedPreferences.OnSharedPreferenceChangeListener changeListener = new SharedPreferences.OnSharedPreferenceChangeListener() {
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            ...
            if (PREF_TIMED_REQUEST.equals(key)) {
                requestPermissions();
            }
        }
    };
